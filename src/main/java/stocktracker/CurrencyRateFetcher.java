...
class CurrencyRateFetcher {
    ...
    public static void main(String[] args) throws IOException  {
        getCurrencyInfo("USD", LocalDate.now().minusDays(365));
        getCurrencyInfo("EUR", LocalDate.now().minusDays(365));
    }

    static List<String> getCurrencyInfo(String currencyCode, LocalDate firstDate) throws IOException {
        ...
        if (!currencyCode.equals("EUR")) {
            ...
            dataList = fetcher.xmlParser.parse();
